...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: build/index.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: build/index.js</h1>
...
module.exports = function () {
    ...
    (0, _createClass3.default)(SimpleNeo4J, [{
        ...
        value: function addQuery(opts) {
            var queueName = arguments.length > 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : "default";
        ...
        value: function commit() {
            ...
            var queryQueueName = arguments.length > 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : "default";
 ...
 * @since 3.3.0
 */
module.exports.tools = _cypherTools2.default;</code></pre>
        </article>
    </section>
